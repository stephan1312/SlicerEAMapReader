# SlicerEAMapReader
This extension for 3D Slicer enables the import of data from various 3D electroanatomic mapping systems.

This software is experimental. Users are advised to check the results in 3D Slicer against the original map on the workstation after importing.

## Installation

This extension requires 3D Slicer 4.11 or higher
In the extension manager select "Install from file" and install the EAMapReader.zip file. 
...
1.	If HD coloring is active, disable it. Biosense Webster field technicians can offer guidance on how to disable and enable this feature.
